    ...
    async (event) => {
      ...
      try {
        ...
        if (result instanceof Promise) {
          // Clear attachments (and provider text) as soon as send starts — the
          // consumer already received `convertedFiles`; awaiting would keep
          // chips visible until long-running work (e.g. streaming) finishes.
          clear()
          if (usingProvider) {
          ...
          try {
            ...
            /* submit failed after UI cleared; user can re-add files */
          }
        } else {
